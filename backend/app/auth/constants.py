...
class AuditAction:
    ...
    CHANGE_PREFLIGHT_SUCCESS = "change.preflight.success"
    CHANGE_PREFLIGHT_FAILURE = "change.preflight.failure"
    CHANGE_PREFLIGHT_STALE_BASELINE = "change.preflight.stale_baseline"
